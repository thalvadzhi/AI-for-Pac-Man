...
def create_board(ghosts, pacman, map_size, map_repr, edible_ghosts, mitak_repr, lives):
    ...
    return Board(map_size, tuple(ghosts), tuple(food), tuple(pills), set(obstacles), tuple(pacman), edible_ghosts, mitak_repr , lives,1)
